              ...
              return (
                <button
                  ...
                  className={`relative px-4 py-1.5 rounded-full text-xs font-mono uppercase tracking-wider transition-all duration-300 flex items-center gap-1.5 cursor-pointer focus:outline-none ${
                    isActive
                      ? isLight
                        ? 'text-white font-bold bg-[#00629B] border border-[#00629B] shadow-md shadow-[#00629B]/25'
            ...
            return (
              <button
                ...
                className={`w-full text-left py-2.5 px-3 rounded-lg flex items-center justify-between transition-all duration-200 ${
                  isActive
                    ? isLight
                      ? 'bg-[#00629B]/10 border border-[#00629B]/30 text-[#00629B] font-bold shadow-sm'
                      : 'bg-[#00629B]/30 border border-[#0096D6]/50 text-white font-bold shadow-[0_0_12px_rgba(0,150,214,0.2)]'
                    : isLight
              ...
              >
                <div className="flex items-center gap-2">
                  <span className={`w-1.5 h-1.5 rounded-full ${isActive ? (isLight ? 'bg-[#00629B]' : 'bg-[#0096D6]') : (isLight ? 'bg-slate-300' : 'bg-zinc-600')}`} />
                  <span>{item.label}</span>
                </div>
